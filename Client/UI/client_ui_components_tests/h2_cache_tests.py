...
class TestH2Cache:
    ...
    def test_init(self, mock_db_connection):
        ...
        h2_jar_file = '/Users/gagebenham/Documents/ECE-382V/Project/Client/Cache/h2-1.4.200.jar'
    ...
    def test_create_cache_table(self, mock_db_connection):
        mock_conn, mock_cursor = mock_db_connection
        cache = H2Cache('/Users/gagebenham/Documents/ECE-382V/Project/Client/Cache/h2-1.4.200.jar')
